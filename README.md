...
```scala
libraryDependencies += "io.monix" %% "monix-kafka-1x" % "1.0.0-RC3"
```
...
```scala
libraryDependencies += "io.monix" %% "monix-kafka-11" % "1.0.0-RC3"
```
...
```scala
libraryDependencies += "io.monix" %% "monix-kafka-10" % "1.0.0-RC3"
```
...
```scala
libraryDependencies += "io.monix" %% "monix-kafka-9" % "1.0.0-RC3"
```
